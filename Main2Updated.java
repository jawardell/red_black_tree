			...
			while (exit) {
				...
				if (choice.equalsIgnoreCase("Name")) {
					...
					case 1:
						...
						key = firstname.substring(0, 1).toUpperCase() + firstname.substring(1) + " "
					...
					if (count > 1) {
						...
						searchByName = searchByFirstName.substring(0, 1).toUpperCase() + searchByFirstName.substring(1)
								+ " " + searchByLastName.substring(0, 1).toUpperCase() + searchByLastName.substring(1);
						found = true;
					} else if (count == 1) {
				...
				if (choice.equalsIgnoreCase("ID")) {
					...
					if (tree.search(searchById)) {// this tiny line searches
													// thru 2000+ ids @
													// lightning speed
